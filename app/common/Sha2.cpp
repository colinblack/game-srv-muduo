...
string Crypt::HmacSha256(const string &text, const string &key)
{
	char buffer[32];
	hmac_sha256((unsigned char *)const_cast<char *>(key.c_str()), key.size(),
			(unsigned char *)const_cast<char *>(text.c_str()), text.size(),
