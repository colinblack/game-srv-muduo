...
ActivityInfo::ActivityInfo()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:ConfigActivityTencent.ActivityInfo)
}
...
ActivityInfo::ActivityInfo(const ActivityInfo& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:ConfigActivityTencent.ActivityInfo)
}
...
ActivityInfo::~ActivityInfo() {
  // @@protoc_insertion_point(destructor:ConfigActivityTencent.ActivityInfo)
  SharedDtor();
}
...
const ActivityInfo& ActivityInfo::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_ConfigActivityTencent_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:ConfigActivityTencent.ActivityInfo)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:ConfigActivityTencent.ActivityInfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:ConfigActivityTencent.ActivityInfo)
  return false;
#undef DO_
}
...
void ActivityInfo::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:ConfigActivityTencent.ActivityInfo)
  // repeated .CommonGiftConfig.CommonModifyItemSimple normal_blue_daily = 1;
  ...
  // @@protoc_insertion_point(serialize_end:ConfigActivityTencent.ActivityInfo)
}

::google::protobuf::uint8* ActivityInfo::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:ConfigActivityTencent.ActivityInfo)
  // repeated .CommonGiftConfig.CommonModifyItemSimple normal_blue_daily = 1;
  for (int i = 0; i < this->normal_blue_daily_size(); i++) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:ConfigActivityTencent.ActivityInfo)
  return target;
}
...
bool ActivityInfo::IsInitialized() const {
  ...
  if (!::google::protobuf::internal::AllAreInitialized(this->normal_blue_daily())) return false;
  if (has_super_blue_daily()) {
  ...
  if (!::google::protobuf::internal::AllAreInitialized(this->blue_grow())) return false;
  if (has_qqgame_privilege_daily()) {
    if (!this->qqgame_privilege_daily().IsInitialized()) return false;
  }
  if (!::google::protobuf::internal::AllAreInitialized(this->qqgame_privilege_grow())) return false;
  return true;
}
