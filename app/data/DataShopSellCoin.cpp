...
//////////////////////////////////////////////////////////////////
int CDataShopSellCoin::Get(DataShopSellCoin &data)
{
	...
	DBCREQ_GET_INT(data, value);

	return 0;
}

int CDataShopSellCoin::Get(vector<DataShopSellCoin> &data)
{
	if (0 == data.size())
	{
		return R_ERR_PARAM;
...
int CDataShopSellCoin::Add(DataShopSellCoin &data)
{
...
int CDataShopSellCoin::Set(DataShopSellCoin &data)
{
...
int CDataShopSellCoin::Del(DataShopSellCoin &data)
{
