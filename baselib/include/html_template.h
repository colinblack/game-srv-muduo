 ...
 * Contact: http://www.nulidex.com/contact
 ...
 modifition:
 1.add Reset_State() function to avoid reload template files for many times in fcgi, paulhuang
 **********************************************************************/
 ...
 */
 ...
 private:
   //! need reload template file mark
   bool bNeedReload;
   //! template file name
 ...
 public:
   ...
   //!to reduce the count of read file, give another reset function
   void Reset_State();
};
